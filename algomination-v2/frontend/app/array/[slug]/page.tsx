...
import { ArrayAlgorithmVisualizer } from "@/components/viz/ArrayAlgorithmVisualizer";
import { AlgoSeoText } from "@/components/viz/AlgoSeoText";
import { Container } from "@/components/ui/Container";

const CATEGORY = "array" as const;

/** Pre-render the live array algorithms at build time. */
  ...
  return (
    <main className="flex flex-1 flex-col py-12">
      <Container className="flex flex-col gap-8">
        ...
        >
          <ChevronLeft size={16} /> All array algorithms
        </Link>
        <ArrayAlgorithmVisualizer slug={slug} />
