@echo off
echo 🚀 Setting up Algomination - Final Clean Version
echo ===============================================
...
echo Creating apps...
python manage.py startapp algorithm_viz
python manage.py startapp user_profiles

REM Create ultra-clean settings with NO external dependencies
echo Creating ultra-clean settings...
(
...
echo     path('', include('algorithm_viz.urls'^)^),
echo ]
...
echo         .header p { color: #7f8c8d; font-size: 18px; }
echo         .algorithm { border: 1px solid #ddd; padding: 20px; margin: 15px 0; border-radius: 8px; transition: transform 0.2s; }
echo         .algorithm:hover { transform: translateY(-2px); box-shadow: 0 4px 15px rgba(0,0,0,0.1); }
echo         .algorithm h3 { color: #2c3e50; margin-top: 0; }
echo         .algorithm h3 a { color: #3498db; text-decoration: none; }
echo         .algorithm h3 a:hover { color: #2980b9; }
echo         .difficulty { background: #3498db; color: white; padding: 5px 12px; border-radius: 15px; display: inline-block; font-size: 12px; font-weight: bold; }
echo         .complexity { color: #7f8c8d; font-size: 14px; margin-top: 10px; }
echo         .content h2 { color: #2c3e50; border-bottom: 2px solid #3498db; padding-bottom: 10px; }
echo     ^</style^>
echo ^</head^>
echo ^<body^>
...
echo         .back-link { color: #3498db; text-decoration: none; font-weight: bold; }
echo         .back-link:hover { color: #2980b9; }
echo         .algorithm-info { background: #ecf0f1; padding: 20px; border-radius: 8px; margin: 20px 0; }
echo         .code-block { background: #2c3e50; color: #ecf0f1; padding: 20px; border-radius: 8px; font-family: 'Courier New', monospace; white-space: pre-wrap; overflow-x: auto; }
echo         .complexity { display: inline-block; margin: 10px 10px 10px 0; padding: 8px 15px; background: #3498db; color: white; border-radius: 20px; font-size: 14px; }
...
from algorithm_viz.models import Algorithm
...
echo ✅ Final clean setup complete!
...
echo ✅ NO naming conflicts - using unique app names!
echo ✅ algorithm_viz and user_profiles apps!
echo.
echo Happy coding! 🚀
pause 